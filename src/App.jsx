...
function App() {
  ...
  /////////////////////////////////
  const [location, setLocation] = useState({ lat: 20.593745789784546, long: 78.96290123456789 });
    ...
    if (navigator.geolocation) {
      ...
      const id = navigator.geolocation.watchPosition(
        ...
        (err) => {
          ...
          setLocationStatus('Location Not identified. Allow app to access your Location');
        },
  ...
  return (
    <>
      ...
      <input type="text" placeholder="Enter Name" value={name} onChange={updateName} />
      <p>{locationStatus}</p> 
